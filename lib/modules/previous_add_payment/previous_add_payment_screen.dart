          ...
          child: Padding(
            ...
            child: Column(
              children: [
                DetailCard(
                  detailKey: 'Date',
                  detailvalue: date(dataProvider.currentRouteCard!.date!, format: 'dd.MM.yyyy'),
                ),
                DetailCard(
