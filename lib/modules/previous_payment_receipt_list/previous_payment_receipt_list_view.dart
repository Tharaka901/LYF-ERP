...
import 'package:gsr/modules/previous_payment_receipt_list/previous_payment_receipt_list_view_model.dart';
...
class _ViewReceiptListScreenState extends State<ViewReceiptListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final _receiptListViewModel = ReceiptListViewModel();
    return FutureBuilder<List<CreditPaymentModel>>(
      future: _receiptListViewModel.getCreditPayments(context),
