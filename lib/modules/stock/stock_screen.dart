                            ...
                            children: [
                              ...
                              ...stockViewModelData.routeCardItems.map(
                                (item) {
                                  ...
                                  bool isNew =
                                      [14, 15, 16, 29].contains(item.itemId);
                                  return TableRow(
                                    children: [
                                      cell(
                                        item.item?.itemName ?? '',
                                      ...
                                      cell(isNew
                                          ? '-'
                                          : emptyCount.toInt().toString()),
                                      cell(
                                        (item.transferQty + emptyCount)
                                            .toInt()
                                            .toString(),
                                        align: TextAlign.end,
                                      ),
                          ...
                          child: Table(
                            ...
                            children: [
                              ...
                              ...stockViewModelData.routeCardItems.map((item) {
                                ...
                                for (var item2
                                    in stockViewModelData.routeCardSoldItems) {
                            ...
                            SizedBox(
                              ...
                              child: Table(
                                ...
                                children: [
                                  ...
                                  ...stockViewModelData.routeCardSoldLoanItems
                                      .map(
                                    (stock) {
                                      return TableRow(
                                        children: [
