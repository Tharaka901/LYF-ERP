...
class PaymentService {
  ...
  Future<List<CreditPaymentModel>> getCreditPayments({
    ...
    String queryParams =
        receiptNo != null ? 'receiptNo=$receiptNo' : 'routecardId=$routecardId';
    final response = await respo('credit-payment/get?$queryParams');
    ...
    if (routecardId != null) {
      ...
      return list
          .map((element) => CreditPaymentModel.fromJson(element))
          .toList();
    }
  }
                ...
                if (paymentDataModel.cash > 0)
                  Payment(
                    ...
                    amount: paymentDataModel.selectedVoucher != null
                        ...
                        : 0.0,
                    chequeNo: paymentDataModel.selectedVoucher != null
                        ? paymentDataModel.selectedVoucher!.code
                        : null,
                    receiptNo: rn,
                    paymentMethod: 3,
                    routecardId: paymentDataModel.currentRouteCard.routeCardId,
      ...
      final data = {
        ...
        "creditInvoiceId":
            creditInvoicePayFromDipositesDataModel.chequeId != null
                ? creditInvoicePayFromDipositesDataModel.chequeId
